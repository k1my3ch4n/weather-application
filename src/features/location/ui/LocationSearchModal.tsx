...
export const LocationSearchModal = ({
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title="위치 검색">
  ...
  focus:ring-blue-500"
        ...
        {hasSuggestLocation && (
          <ul
            ...
            role="listbox"
            aria-label="검색 결과"
            className="mt-2 max-h-48 overflow-y-auto border border-gray-200 rounded-lg"
          >
            {suggestLocation.map((suggestion, index) => (
              <li
                key={index}
                role="option"
                aria-selected={selectedAddress === suggestion}
